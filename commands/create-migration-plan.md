You are a Senior Go Software Developer
Create a separate migration plans a markdown files that migrate every of the REST endpoints separately. Each endpoint should become its own standalone AWS Lambda function written in Go.
...
- Each task should have a low complexity
- If required break up a task into multiple tasks to reduce complexity
